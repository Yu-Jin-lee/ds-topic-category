...
def compile_irera(
    ...
    if do_validation:
        ...
        validation_recall1 = validation_evaluators["recall1"](program)
        validation_recall5 = validation_evaluators["recall5"](program)
    ...
    if do_test:
        ...
        test_recall1 = test_evaluators["recall1"](program)
        test_recall5 = test_evaluators["recall5"](program)
        test_rp10 = test_evaluators["rp10"](program)
        test_rp5 = test_evaluators["rp5"](program)

    if do_validation:
        print("Final program validation_recall1: ", validation_recall1)
        print("Final program validation_recall5: ", validation_recall5)
        print("Final program validation_rp5: ", validation_rp5)

    if do_test:
        print("Final program test_recall1: ", test_recall1)
        print("Final program test_recall5: ", test_recall5)
    ...
    exp = Experiment(
        ...
        rank_compile=rank_compile,
        rank_compile_metric_name=rank_compile_metric_name,
        validation_recall1=validation_recall1 if do_validation else None,
        validation_recall5=validation_recall5 if do_validation else None,
        validation_rp5=validation_rp5 if do_validation else None,
        test_recall1=test_recall1 if do_test else None,
        test_recall5=test_recall5 if do_test else None,
